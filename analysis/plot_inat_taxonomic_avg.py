...
org_df = pd.read_csv("inat_analysis.csv")
...
x_labels = ["kingdom", "phylum", "class", "order", "family", "genus", "full"]
...
x_labels = ["kingdom", "phylum", "class", "order", "family", "genus", "species"]
...
fig.savefig("inat_taxonomic_performance_avg.pdf", bbox_inches="tight")
